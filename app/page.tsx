          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto mb-16">
            ...
            <Card className="bg-white border-gray-200 hover:border-red-300 transition-colors group hover:shadow-lg">
              <CardHeader className="text-center pb-4">
                ...
                <CardTitle className="text-xl text-gray-900">Organizer Portal</CardTitle>
                <CardDescription className="text-gray-600">
                  View reports, monitor activity, and manage the platform overview
                </CardDescription>
              </CardHeader>
              <CardContent className="text-center">
                <ul className="text-sm text-gray-600 mb-6 space-y-2 text-left">
                  <li>• Platform usage statistics</li>
                  <li>• Student & recruiter activity</li>
                  <li>• Job posting & application insights</li>
                  <li>• AI assessment trends</li>
                </ul>
                <Link href="/organizer">
                  <Button className="w-full bg-red-600 hover:bg-red-700 text-white">
